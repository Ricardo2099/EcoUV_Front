// FILE: src/pages/CareerGroupPage.jsx
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 grid grid-cols-12 gap-6">
        ...
        <section className="col-span-9 space-y-6">
          <div className="card p-6 text-white border border-white/10">
            <h1 className="text-2xl font-bold mb-2">Grupo de carrera</h1>

            <p className="text-gray-300 mb-4">
              Aquí podrás ver todas las publicaciones relacionadas con tu carrera.
            </p>

            {/* Aquí luego listas las publicaciones del grupo */}
            <div className="mt-6 text-gray-400 italic">
              Aquí se mostrarán las publicaciones del grupo de carrera...
            </div>
          </div>
        </section>
      </main>
