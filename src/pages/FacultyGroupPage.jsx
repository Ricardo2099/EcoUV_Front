// FILE: src/pages/FacultyGroupPage.jsx
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 grid grid-cols-12 gap-6">
        ...
        <section className="col-span-9 space-y-6">
          ...
          <div className="card p-6 text-white border border-white/10">
            ...
            <h1 className="text-2xl font-bold mb-2">Grupo de Facultad</h1>

            <p className="text-gray-300 mb-4">
              Aquí podrás ver todas las publicaciones dirigidas a tu facultad.
            </p>

            {/* Placeholder de publicaciones */}
